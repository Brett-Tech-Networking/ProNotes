...
public class MainActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        } else if (item.getItemId() == R.id.unhide) {
    ...
    private void updateExistingNote(Notes new_notes) {
    ...
    private void startModifiedNotes(Notes notes) {
        Intent intent;
        if (notes.getNoteType() == 2) {
            intent = new Intent(MainActivity.this, ChecklistNotesActivity.class);
        } else {
            intent = new Intent(MainActivity.this, NotesTakerActivity.class);
        }
        ...
        switch (item.getItemId()) {
            ...
            case R.id.lock:
                if (keyguardManager.isKeyguardSecure()) {
                    ...
                    Toast.makeText(MainActivity.this, "The device does not have a PIN or password set", Toast.LENGTH_SHORT).show();
                }
                return true;
            default:
                return false;
